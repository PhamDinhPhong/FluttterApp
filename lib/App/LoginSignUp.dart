              ...
              Padding(
                ...
                children: [
                  Container(
                    ...
                    child: Text('Sign In', style: TextStyle(fontSize: 34, fontWeight: FontWeight.w700),),
                  ),
                  SizedBox(height: 20),
                  Container(
                    alignment: Alignment.topLeft,
                    child: Text('Welcome back, Guys', style: TextStyle(fontSize: 24, color: Colors.green),),
                  ),
                  SizedBox(height: 30,),
                ],
                ),
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        width: 40,
                        height: 40,
                        child: Image(image: AssetImage('assets/images/Group 9.png'),),
                        decoration: BoxDecoration(
                            color: Colors.white,
                      ...
                      Container(
                        ...
                        height: 40,
                        child: Image(image: AssetImage('assets/images/Group 8.png'),),
                        decoration: BoxDecoration(
                            color: Colors.white,
                            borderRadius: BorderRadius.circular(5)
                        ),
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Text('Sign Up', style: TextStyle(color: Colors.greenAccent, fontSize: 14),),
                    ),
                  )
                ],
              ),
